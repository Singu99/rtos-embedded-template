...
static const etl::unordered_map<pal::timer::id, pal::stm32::timer_hardware_t, TIM_COUNT> timer_hardware = {
    ...
    { 
        ...
        .channels = 
        {
            {
                .af = GPIO_AF1_TIM1,
                .dma_req = DMA_REQUEST_TIM1_CH1
            },
            {
                .af = GPIO_AF1_TIM1,
                .dma_req = DMA_REQUEST_TIM1_CH2
            },
            {
                .af = GPIO_AF1_TIM1,
                .dma_req = DMA_REQUEST_TIM1_CH3
            },
            {
                .af = GPIO_AF1_TIM1,
                .dma_req = DMA_REQUEST_TIM1_CH4
            }
        }  
    }},
